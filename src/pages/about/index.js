    ...
    <StyledAbout>
      <div className="border-shadow about">
        ...
        <p>
          ...
          <blockquote>
            <strong>
              No responsibility is accepted for any inaccuracies contained in
              the matter published. Securities that have had no short sales
              actively reported for the date shown are excluded from this
              report.
            </strong>
          </blockquote>
